...
const ProjectData = [
  {
    title: "You Tube ",
    subtitle: "mini clone",
    content: "responsive React JS application consisting of stunning video sections, custom categories, channel pages, and, most importantly, you can play videos straight from your YouTube Clone App!.",
    image: youtube,
    url: "https://strong-palmier-bee44e.netlify.app",
  },
  {
    title: "Redcliffelabs",
...
const Pojects = () => {
  return (
    <Container id="projects">
      <Typography variant="h4">My Projects , total {ProjectData.length}</Typography>
      <Box pt={3} pb={13}>
        <ContainerProject>
